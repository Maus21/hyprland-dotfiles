...
Item {
    ...
    readonly property color cardColor: panelColor
    readonly property color cardBorderColor: borderColor
    readonly property color workspaceColor: moduleColor
    readonly property color workspaceHoverColor: moduleHover
    readonly property color workspaceBorderHoverColor: activeBorderColor
                    ...
                    delegate: Row {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                border.width: 1
                                border.color: hoveredDrag ? root.workspaceBorderHoverColor : root.borderColor
                                clip: true
