...
Item {
    ...
    property string batteryModeStateOutput: ""
    property string batteryModeStateError: ""
    ...
    property color cardAccent: "#ff4f7b"
    property color cardAccentAlt: "#67c7ea"
    ...
    readonly property color cardAccentPressed: Qt.darker(cardAccent, 1.18)
    readonly property color cardFillActive: Qt.tint(moduleColor, Qt.rgba(1, 1, 1, 0.08))
    readonly property color cardFillHover: moduleHover
    readonly property color buttonFill: textPrimary
    ...
    function refreshBatteryModeState() {
        ...
        batteryModeStateOutput = "";
        batteryModeStateError = "";
        powerProfileStateProcess.running = true;
    }
    ...
    function applyBatteryModeState(available, profile, output, errorString) {
        ...
        if (!batteryTlpAvailable) {
            ...
            batteryModeError = trimString(errorString).length > 0 ? errorString : "Power profiles are unavailable.";
            setBatteryModeVisualIndex(batteryModeAppliedIndex, true);
            return;
        }

        if (batteryModeError === "Power profiles are unavailable.")
            batteryModeError = "";

        const resolvedProfile = trimString(profile);
    ...
    function buildBatteryModeStatusText() {
        ...
        if (trimString(userConfig.tlpPermissionMode) === "skip") return "Power profiles disabled";
        if (!batteryTlpChecked) return "Checking power profiles";
        if (!batteryTlpAvailable) return "Power profiles unavailable";
    ...
    function classifyBatteryModeFailure(exitCode) {
        ...
        if (details.indexOf("not authorized") >= 0 || details.indexOf("permission denied") >= 0)
            return "Power profile permission was denied by the system.";
        if (details.indexOf("failed to communicate") >= 0 || details.indexOf("unavailable") >= 0)
            return "power-profiles-daemon is unavailable.";
        return "The system could not apply that power profile.";
    }
    ...
    function selectBatteryMode(index) {
        if (batteryModeBusy) {
            if (batteryModeSetterRunning)
                powerProfileSetProcess.running = false;
            batteryModeBusy = false;
        ...
        if (trimString(userConfig.tlpPermissionMode) === "skip") {
            rollbackBatteryMode("Power profile switching is disabled in Settings.");
            return;
        }
        ...
        if (!batteryTlpAvailable) {
            rollbackBatteryMode("Power profiles are unavailable.");
            return;
        }
        ...
        powerProfileSetProcess.command = ["powerprofilesctl", "set", batteryModeCommand(nextIndex)];
    ...
    function toggleFocus() {
        ...
        requestNotification("Focus", focusEnabled ? "Focus enabled" : "Focus disabled",
            focusEnabled ? "Notifications paused" : "");
        focusBusy = false;
    }
    ...
    Process {
        id: powerProfileStateProcess
        command: ["powerprofilesctl", "get"]
        running: false

        stdout: SplitParser {
            onRead: data => controlCenter.batteryModeStateOutput = controlCenter.trimString(data)
        }

        stderr: SplitParser {
            onRead: data => controlCenter.batteryModeStateError = controlCenter.trimString(data)
        }

        onExited: function(exitCode) {
            const profile = controlCenter.trimString(controlCenter.batteryModeStateOutput);
            const errorText = exitCode === 0
                ? ""
                : (controlCenter.trimString(controlCenter.batteryModeStateError).length > 0
                    ? controlCenter.batteryModeStateError
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => controlCenter.batteryModeLastCommandOutput = controlCenter.trimString(data)
        }
        ...
        onExited: function(exitCode) {
            console.info("[PowerProfile] Apply finished:", exitCode);
            controlCenter.finishBatteryModeApply(
                exitCode === 0,
                exitCode,
                controlCenter.batteryModeLastCommandOutput,
                exitCode === 0 ? "" : controlCenter.batteryModeLastCommandOutput
            );
        }
    }
    ...
    Column {
            ...
            Row {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        border.color: controlCenter.textSecondary
                        border.width: 1
                        ...
                        Rectangle {
                            ...
                            color: {
                                if (batteryCapacity <= 10) return controlCenter.errorColor;
                                if (batteryCapacity <= 20) return controlCenter.warningColor;
                                return controlCenter.successColor;
                            }
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        height: 20
                        radius: 10
                        color: wifiEnabled ? controlCenter.successColor : controlCenter.textSecondary
                        ...
                        Rectangle {
                            ...
                            y: 2
                            x: wifiEnabled ? 16 : 2
                            color: controlCenter.selectedTextColor
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            text: "›"
                            color: wifiPanelOpen ? "#c7c9cf" : controlCenter.textSecondary
                            font.pixelSize: 17
                            font.family: textFontFamily
                            font.weight: Font.DemiBold
                        }
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        anchors.topMargin: 12
                        text: bluetoothGlyph
                        color: bluetoothEnabled ? cardAccent : controlCenter.textSecondary
                        font.pixelSize: 18
                        font.family: iconFontFamily
                    }
                    ...
                    Rectangle {
                        ...
                        height: 20
                        radius: 10
                        color: bluetoothEnabled ? controlCenter.successColor : controlCenter.textSecondary
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            text: "›"
                            color: bluetoothPanelOpen ? "#c7c9cf" : controlCenter.textSecondary
                            font.pixelSize: 17
                            font.family: textFontFamily
                            font.weight: Font.DemiBold
                        }
        ...
        Item {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    color: controlCenter.batteryModeError.length > 0 ? controlCenter.errorColor : controlCenter.textSecondary
                        ...
                        Repeater {
                            ...
                            delegate: Item {
                                ...
                                Rectangle {
                                    ...
                                    radius: 12
                                    color: index === controlCenter.batteryModeIndex ? controlCenter.textPrimary : controlCenter.moduleColor
                                    ...
                                    Text {
                                        ...
                                        color: index === controlCenter.batteryModeIndex ? controlCenter.moduleColor : controlCenter.textSecondary
            ...
            Rectangle {
                ...
                Item {
                    ...
                    property color iconColor: controlCenter.focusEnabled ? controlCenter.textPrimary : controlCenter.textPrimary
                    ...
                    Text {
                        ...
                        width: parent.width
                        text: "Silent"
                        color: controlCenter.focusEnabled ? controlCenter.textPrimary : controlCenter.textSecondary
                ...
                Item {
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            anchors.centerIn: parent
                            text: controlCenter.nightLightGlyph
                            color: controlCenter.nightLightEnabled ? controlCenter.textPrimary : controlCenter.textPrimary
                            font.pixelSize: 29
                            font.family: iconFontFamily
                            scale: nightLightButtonMouse.pressed ? 0.94 : 1.0
                    ...
                    Text {
                        ...
                        width: parent.width
                        text: "Night mode"
                        color: controlCenter.nightLightEnabled ? controlCenter.textPrimary : controlCenter.textSecondary
                        horizontalAlignment: Text.AlignHCenter
                        font.pixelSize: 10
                        font.family: textFontFamily
                        font.weight: Font.Medium
            ...
            Item {
                ...
                Rectangle {
                    ...
                    height: 5
                    radius: 3
                    color: controlCenter.batteryDrawerOpen ? controlCenter.textPrimary : controlCenter.textSecondary
                    opacity: 0.88
                }
        ...
        ControlSliderCard {
            ...
            selectedTextColor: controlCenter.selectedTextColor
