                            ...
                            Row {
                                ...
                                Repeater {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        radius: 2
                                        color: isPlaying ? root.accentColor : root.accentAltColor
                                        anchors.verticalCenter: parent.verticalCenter
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            Item {
                                ...
                                Canvas {
                                    anchors.fill: parent
                                    property color fillColor: prevArea.pressed ? root.textSecondary : root.textPrimary
                            ...
                            Item {
                                ...
                                Canvas {
                                    anchors.fill: parent
                                    visible: !activePlayer || activePlayer.playbackState !== MprisPlaybackState.Playing
                                    property color fillColor: playArea.pressed ? root.textSecondary : root.textPrimary
                            ...
                            Item {
                                ...
                                Canvas {
                                    anchors.fill: parent
                                    property color fillColor: nextArea.pressed ? root.textSecondary : root.textPrimary
        ...
        Item {
            ...
            Rectangle {
                ...
                color: buttonRoot.accent
                    ? (buttonArea.pressed ? root.accentAltColor : root.accentColor)
                    : StyleTokens.transparent
                border.width: 1
                border.color: buttonRoot.accent ? root.accentColor : root.borderColor
            }
        }
