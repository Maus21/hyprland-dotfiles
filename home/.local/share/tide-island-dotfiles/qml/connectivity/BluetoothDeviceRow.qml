...
Rectangle {
    ...
    readonly property string subtitleText: section === "connected"
        ...
        : (hasProvider && provider.bluetoothDeviceSubtitle
            ...
            : "")
    readonly property color iconColor: section === "available" ? root.textSecondary : root.accentColor
    ...
    Item {
        ...
        Text {
            ...
            color: root.section === "connected" ? root.successColor : root.textPrimary
